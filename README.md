...
```
dotnet new ca-usecase --name CreateAlgorithmProblem --feature-name AlgorithmProblems --usecase-type command --return-type int
```

Create a new query:

```
dotnet new ca-usecase -n GetProblems -fn AlgorithmProblems -ut query -rt ProblemsVm
```
